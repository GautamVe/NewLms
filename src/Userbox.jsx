    ...
    <>
      <div className="w-3/12 h-auto bg-slate-50 absolute right-0  rounded-md mt-16 gap-2 flex flex-col">
        <div className="flex flex-col justify-center items-center border-2 m-1 p-3">
          <div className="w-12 h-12 bg-green-700 rounded-full flex justify-center items-center relative ">
            <span className="font-bold ">G</span>
          </div>
          <h3>Gautam verma</h3>
          <h5>Gautamverma1807@gmail.com</h5>
          <h5>8630522147</h5>
        </div>
        <div className="flex justify-between justify-center items-center border-2 m-1">
